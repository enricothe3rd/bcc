...
<head>
    ...
    <style>
      /* Custom styles to help visualize breakpoints */
        ...
        .bg-xs { background-color: rgba(255, 0, 0, 0.7); }
        .bg-sm { background-color: rgba(0, 255, 0, 0.7); }
        .bg-md { background-color: rgba(0, 0, 255, 0.7); }
        .bg-lg { background-color: rgba(255, 255, 0, 0.7); }
        .bg-xl { background-color: rgba(255, 0, 255, 0.7); }
        .bg-2xl { background-color: rgba(0, 255, 255, 0.7); }
...
<div class="responsive-indicator bg-xs text-xs sm:bg-sm md:bg-md lg:bg-lg xl:bg-xl 2xl:bg-2xl">
    <span class="block md:hidden">XS</span>
    <span class="hidden md:block lg:hidden">SM</span>
    <span class="hidden lg:block xl:hidden">MD</span>
    <span class="hidden xl:block 2xl:hidden">LG</span>
