            ...
            <head>
                <style>
                   ...
                   .btn {
                        ...
                        background-color: #B80000; /* Background color remains the same */
            ...
            <body>
                <div class="email-container">
                    ...
                    <div class="content">
                        ...
                        <a href="http://bccenrollment.xyz/reset_password.php?token=' . $reset_token . '" class="btn">Reset Password</a>
                    </div>
                    <div class="footer">
